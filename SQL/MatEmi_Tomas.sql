--create database matemi_tomas_practica;
/*
...
select CONCAT(c.name,' ', c.last_name) as NombreApellido , count(o.id) as OrdersPerClient
...
FROM
    products p, order_details d, genders g
where d.id_product = p.id and p.id_gender = g.id
GROUP BY
    g.gender
order by Total desc;
...
where e.id = o.id_employee and o.date>= '2024-01-12' and o.date<='2024-01-15'
...
from employees e, 
		orders o
where e.id = o.id_employee and 
		o.date>= '2024-01-12' and 
		o.date<='2024-01-15'
order by o.date desc, 
		e.legajo asc

select pm.payment_method as 'Payment method', 
		count(o.id_payment_method)AS 'CantidadDePagos'
from payment_methods pm, 
		orders o
where o.id_payment_method = pm.id 
